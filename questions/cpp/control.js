// control.js — 13 questions — IDs: 1016,1017,1018,1019,1043,1044,1045,1046,1047,1048,1049,1050,1020
...
int main() {
    ...
    answer: 0,
    explanation: `i goes 1,2,3,4,5,6,7…. When i=3: <code>continue</code> skips print. i=4: prints 4. i=5: prints 5. i=6: <code>continue</code> skips. i=7: <code>break</code> exits loop (7>6 triggers before the print). So output is <code>1 2 4 5 </code>. The <code>i++</code> runs before both checks each iteration.`,
  },
...
int main() {
    ...
    answer: 0,
    explanation: `<code>std::string</code> overloads <code>==</code> to compare contents character by character — not memory addresses. This is unlike C-style char arrays, where <code>==</code> compares pointers and almost never does what you expect. <code>"hello" == "hello"</code> is <code>true</code>, so <code>"match"</code> is printed.`,
  },
