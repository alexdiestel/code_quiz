// exceptions.js — 12 questions — IDs: 286-297
const PY_EXCEPTIONS = [
  {
    id: 286, category: 'exceptions', difficulty: 'easy',
    code: `try:
    x = int("abc")
except ValueError:
    print("caught")`,
  ...
  {
    id: 287, category: 'exceptions', difficulty: 'easy',
    code: `try:
    result = 10 / 0
  ...
  {
    id: 288, category: 'exceptions', difficulty: 'easy',
    code: `try:
    x = 1
except Exception:
    print("error")
  ...
  {
    id: 289, category: 'exceptions', difficulty: 'easy',
    code: `try:
